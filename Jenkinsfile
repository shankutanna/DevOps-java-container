node {
    ...
    stage('Clone Repo') { // for display purposes
      ...
      git 'https://github.com/umatanna9/DevOps-Example.git'
      // Get the Maven tool.
    ...
    stage('Deploy Docker Image and login'){
      ...
      echo "Docker Image Tag Name: ${dockerImageTag}"
        ...
        sh "docker images"
        sh "docker login -u umatanna9 -p Hello@123" // put PWD
	...
	//sh "read imageid"
	   sh "docker tag 5f3522b20cdf  umatanna9/myapplication" //must change your name and tag no
